...
export default function TeamLogin({ onSuccess, onError }: TeamLoginProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Clear any existing individual Appwrite session before team login
      try {
        const { account } = await import('@/lib/appwrite');
        await account.deleteSession('current');
        console.log('[Team Login] Cleared existing Appwrite session');
      } catch {
        // No existing session, which is fine
        console.log('[Team Login] No existing Appwrite session to delete');
      }
      ...
      console.log('[Team Login] Attempting team login with teamCode:', trimmedCredentials.teamCode);
      ...
      if (result.success) {
        ...
        console.log('[Team Login] ✅ Team login successful');
        ...
        console.log('[Team Login] ❌ Team login failed:', errorMessage);
      ...
      console.error('[Team Login] Team login error:', error);
